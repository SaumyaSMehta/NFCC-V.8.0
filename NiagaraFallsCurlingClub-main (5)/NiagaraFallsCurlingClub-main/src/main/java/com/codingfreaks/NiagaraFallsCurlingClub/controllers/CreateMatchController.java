...
public class CreateMatchController {
  ...
  public String createMatchPost(RedirectAttributes redirectAttrs, ModelMap model, 
  @RequestParam String matchName,@RequestParam String matchDate,@RequestParam String teamId1,@RequestParam String teamId2,@RequestParam Integer sheetNumber,
      ...
      System.out.println("randiiiiiiiiiiiiiiiii anujjjjjjjj"+matchName+matchDate+teamId1+team1.get().getTeamName());


      Match match=new Match(matchName,teamId1,teamId2,sheetNumber,team1.get().getTeamName(),team2.get().getTeamName(),matchDate);
